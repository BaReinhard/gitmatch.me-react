...
export default class LocationPageComponent extends React.Component {
    ...
    GitLocation = async event => {
        ...
        try {
            ...
            let topStarNameResponse = await this.getTopStarNames(
                locationResponse.city,
                this.state.selectedLanguages[0],
            );
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    console.log(this.state.elements);
                    this.scrollTo('results-location');
                }, 250);
            }, 750);
    ...
    displayLanguagesModal = () => {
        this.setState({
            showLanguagesModal: !this.state.showLanguagesModal,
        });
    };
    render() {
        return (
            <div style={{ height: '100%', width: '100%' }}>
                <GitLocationForm
                    ...
                    onLanguageSelect={this.handleLanguageClick}
                    select={this.select}
